...
#     1
echo -e "align reads to general reference file";
bbmap.sh -Xmx4g ow  ref="$reference" in1="$R1" in2="$R2" outm="$OUT1" nodisk local maxindel=500 k=12 ow > "$LOG1" 2>&1;
...
dedupebymapping.sh -Xmx2G in="$OUT1" out="$OUT1b" -Xmx31g ow > "$LOG2" 2>&1;
